...
There is an approximate hierarchy of color spaces when considering biological questions, with the best options typically requiring more expertise, expensive equipment, and specialized data collecting conditions in exchange for more precise results. Briefly:
...
3. "Computer-friendly" coordinate models like RGB, HSV, or CMYK. Requires a commercial digital camera and little finessing.
...
* [Introduction to Colour Spaces](https://www.colourphil.co.uk/lab_lch_colour_space.shtml) (very little math)
* [Hill, B., Roger, T., & Vorhagen, F. W. (1997). Comparative analysis of the quantization of color spaces on the basis of the CIELAB color-difference formula. *ACM Transactions on Graphics (TOG), 16*(2), 109-154.](https://dl.acm.org/citation.cfm?id=248212)